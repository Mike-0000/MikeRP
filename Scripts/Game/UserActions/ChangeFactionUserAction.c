...
//class MyCustomNotification : SCR_NotificationPlayer
//{
//	ref TStringArray ClockedInMessages = new TStringArray;
//		ClockedInMessages.Insert("Shift Officer Dawdle: You’re clocked in. Time to serve justice, with a side of donuts!");
//		ClockedInMessages.Insert("Shift Officer Stone: Clocked in. You’re the barrier between order and chaos—hold the line.");
//		ClockedInMessages.Insert("Shift Officer Dawdle: You’re clocked in, partner. Time to save the day, or at least look busy trying!");
//		ClockedInMessages.Insert("Shift Officer Dawdle: You’re on duty, officer. Remember: the law never sleeps, but naps are totally fine!");
//		ClockedInMessages.Insert("Shift Officer Stone: You’re on the job. Make sure these streets remember who’s in control.");
//		ClockedInMessages.Insert("Shift Officer Stone: You’re on duty. This city’s fate rests in your hands—don’t let it slip.");
//
//
//    private string customMessage;
//
//    // Set the custom message that will be displayed in the notification
//    void SetCustomMessage(string message)
//    {
//        customMessage = message;
//    }
//
//    // Override the GetText() function to return the custom message
//    override string GetText()
//    {
//        return customMessage; // The notification text will be whatever is in customMessage
//    }
//}
